...
import com.example.physioconsult.login.RegisterActivity
...
//            val image: Painter =
//                painterResource(id = com.google.android.material.R.drawable.abc_ic_star_black_16dp)
//            Image(
//                painter = image,
...
fun LogInFormPreviewDark() {
    PhysioConsultTheme(darkTheme = true) {
        PhysioConsultTheme {
            LogInForm()
        }
    }
